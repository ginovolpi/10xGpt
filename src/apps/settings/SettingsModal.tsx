  ...
  return (
    <GoodModal title={`Preferences`} open={!!settingsOpenTab} onClose={closeSettings}
      ...
      <Tabs aria-label='Settings tabbed menu' defaultValue={settingsOpenTab} sx={{ borderRadius: 'lg' }}>
        ...
        <FormHelperText>
        🔑 Click on the Below button to fill the form to get all API Keys and pay the Charges
      </FormHelperText>
      <br></br>
      <Link href="https://forms.gle/VyG8zsoJLCHaFTVZ9">
        <Button>
          Press to go to the Form Page
        </Button>
        </Link>
        </TabPanel>
      </Tabs>
